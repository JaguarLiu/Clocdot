  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-slate-900">
      <div className="w-full max-w-md bg-white rounded-2xl shadow-2xl p-10">
        ...
        {error && (
          <div className="mb-6 px-4 py-3 bg-red-50 border border-red-200 rounded-lg text-sm font-semibold text-red-600 text-center">
            {error}
          </div>
        )}
        ...
        <button
          onClick={handleLogin}
          disabled={isLoading}
          className="w-full flex items-center justify-center gap-3 bg-white border-2 border-slate-200 rounded-xl px-6 py-4 font-bold text-slate-700 hover:border-slate-300 hover:shadow-md transition-all disabled:opacity-60 disabled:pointer-events-none"
        >
        ...
        <p className="mt-8 text-center text-[11px] text-slate-300 font-semibold">
          僅限管理員帳號登入
        </p>
      </div>
    </div>
